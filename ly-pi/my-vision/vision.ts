...
- You do not have vision capability. When the user asks you to analyze an image, screenshot, chart, or diagram, delegate to the \`image-reader\` subagent via \`subagent({ agent: "image-reader", task: "..." })\`.
