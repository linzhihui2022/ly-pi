...
export const prosecutorAnalyzerConfig: AnalyzerConfig<
  JudgeLogEntry[],
  ProsecutorSuggestion
> = {
  systemPrompt: [
  ...
  buildUserPrompt: (entries, cwd, currentJudgeMd, judgePrompt) =>
    buildProsecutorPrompt(entries, currentJudgeMd, judgePrompt, cwd),
